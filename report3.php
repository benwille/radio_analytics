...
*/           
    ...
    echo "<center><h3>Reporting with data from: " . $filename . "</h3></center><br>";
    echo "<br><br>";
...
?>
  ...
  while(i < data.length) {
      ...
      // 5 = page views
      // 6 = session
      googleYear = parseInt(data[i][0]);
      googleMonth  = parseInt(data[i][1]);
      googleDay = parseInt(data[i][2]);
      googleHour = parseInt(data[i][3]);
      googleMinute = parseInt(data[i][4]);
      ...
      if (creative2[x] != null && (googleDay >= airDate)) {
        ...
        if (includeThisOne) {
            s += "<td style='color:red'>" + data[i][0] + "</td>";
            s += "<td style='color:red'>" + data[i][1] + "</td>";
            s += "<td style='color:red'>" + data[i][2] + "</td>";
            s += "<td style='color:red'>" + data[i][3] + "</td>";
            s += "<td style='color:red'>" + data[i][4] + "</td>";
            s += "<td style='color:red'>" + data[i][5] + "</td>";
            s += "<td style='color:red'>" + data[i][6] + "</td></tr>";
            ...
            pageViews += parseInt(data[i][5]);
            sessions  += parseInt(data[i][6]);
            overallViews += parseInt(data[i][5]);
            overallSessions += parseInt(data[i][6]);
            radioHourlyViews[ parseInt(data[i][3]) ] += parseInt(data[i][5]);
            webHourlyViews[ parseInt(data[i][3]) ] += parseInt(data[i][5]);
            ...
            if (creative2[x] != null && typeof creative2[x] != 'undefined' && typeof creative2[x].ISCI != 'undefined') {
                ...
                var newOne = parseInt(isciList[index].Views) + parseInt(data[i][5]);
                isciList[index].Views = newOne;
                var newTwo = parseInt(isciList[index].Sessions) + parseInt(data[i][6]);
            ...
            */
            if (lastHour >= 6 && lastHour < 10) { // morning
                isciList[index].Morning += parseInt(data[i][5]);
            }
            else if (lastHour >= 10 && lastHour < 15) { // midday
                isciList[index].Midday += parseInt(data[i][5]);
            }
            else if (lastHour >= 15 && lastHour < 19) { // afternoon
                isciList[index].Afternoon += parseInt(data[i][5]);
            }
            else if (lastHour >= 19 && lastHour <= 23) { // evening
                isciList[index].Evening += parseInt(data[i][5]);
            }
            else {  // overnight
                isciList[index].Overnight += parseInt(data[i][5]);
            }
...
/*
    var topDay = adsMorning;
    var daypartTotal = adsMorning + adsMidday + adsAfternoon + adsEvening + adsOvernight;
    var topDayName = "Morning";

    if (adsMorning < adsMidday) {
        topDay = adsMidday;
        topDayName = "Midday";
    }
    if (topDay < adsAfternoon) {
        topDay = adsAfternoon;
        topDayName = "Afternoon";
    }
    if (topDay < adsEvening) {
        topDay = adsEvening;
        topDayName = "Evening";
    }
    if (topDay < adsOvernight) {
        topDay = adsOvernight;
