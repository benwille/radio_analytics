...
/*
    ...
    if ($propertyResult) {
        ...
        if ($rcount > 0) {
            ...
            echo "<br>We found no records for propertyID: " . $propertyID . "<br>";
        }
...
*/
    ...
    $response = getReport($client, $propertyID, $startDate, $endDate);
...
?>
    ...
    <table border="1" width="90%" cellpadding="20" cellspacing="0" align=center>
      <tr bgcolor=#AED6F1>
        <th>Radio Visits</th><th>Total Ad Spots</th><th>Visitors/Ad</th>
      </tr>
      <tr>
        <td align=center id="allVisits">Loading.....</td>
        <td align=center id="overAllAdCount"> <?php echo  $rowcount ?> </td>
        <td align=center id="allAverage">Loading....</td>
      </tr>
    </table>
    <br><br><br>
      ...
      <table class="columns">
          <tr>
              <td style="vertical-align: top;">
                <div id="chart_div" style="border: 1px solid #ccc position: -webkit-sticky; /* Safari */ position: sticky; top: 0;"></div>
              </td>
...
?>
    ...
    <table border="1" width="90%" cellpadding="20" cellspacing="0" align=center>
      <tr bgcolor=#AED6F1>
        <th>Top Daypart</th><th>Total Radio Visits</th><th>Total Aired Spots</th>
      </tr>
      <tr>
        <td align=center id="topDaypart">0</td>
        <td align=center id="totalRadioVisits">0</td>
        <td align=center id="totalAiredSpots">0</td>
      </tr>
    </table>
...
?>
    ...
    <div id="chart" class="table-responsive">
      ...
      <p id=pagebreak style="page-break-before: always">
      <center><h4 id=continued>Report 4 continued</h4></center>
      <table class="columns">
...
?>
    ...
    <table border="1" width="90%" cellpadding="20" cellspacing="0" align=center>
      <tr bgcolor=#AED6F1>
        <th>Traffic From Ads</th><th>Total Radio Visits</th><th>Total Website Visits</th>
      </tr>
      <tr>
        <td align=center id="adTraffic">0</td>
        <td align=center id="radioVisits">0</td>
        <td align=center id="overallVisits">0</td>
      </tr>
    </table>
...
?>
    ...
    <br><br><br>
        <table id="dataTable" class="table" border="1">
            <thead><tr><th>Station</th><th>Advertiser</th><th>Air Day</th><th>ISCI</th><th>Air Hour</th><th>Air Minute</th><th>Year</th><th>Month</th><th>Day</th><th>Hour</th><th>Minute</th><th>Pageviews</th><th>Sessions</th></tr></thead>
            <tbody id="tbody">
            </tbody>
        </table>
    </center>
...
<script>
    ...
    function drawReport1Creatives(data) {
        ...
        var h = (data.getNumberOfRows() * 25) + 50;
        table.draw(data, {showRowNumber: true, width: 900, height: h});
    }
    ...
    function drawTable(data) {
        ...
        //alert("the table has this many rows: " + data.getNumberOfRows());
        var h = (data.getNumberOfRows() * 25) + 50; // it was 400
        table.draw(data, {showRowNumber: true, width: 400, height: h});
    }
    ...
    function drawReport4Dayparts(data) {
        ...
        table.draw(data, {showRowNumber: true, width: 900, height: 200});
    }
    function drawReport4Stations(data) {
        ...
        var h = (data.getNumberOfRows() * 25) + 50; // this was 400 before
        if (data.getNumberOfRows() < 20) {
          document.getElementById("pagebreak").style = "none";
          document.getElementById("continued").innerHTML = "";
        }
        table.draw(data, {showRowNumber: true, width: 900, height: h});
    }
...
<?php
     ...
     */
    function getReport($client, $propertyID, $startDate, $endDate) {
        ...
        //echo "The startDate is: " . $startDate . " and the end date is: " . $endDate . "<br>";
    ...
    */
    ...
    function showData($data)  {
        ...
        for($i = 0; $i < sizeof($data->columnHeader->dimensions);$i++)  {
            echo "<td>";
            print_r($data->columnHeader->dimensions[$i]);
            echo "</td>";
        }
        for($i = 0; $i < sizeof($data->columnHeader->metricHeader->metricHeaderEntries);$i++)   {
            echo "<td>";
            print_r($data->columnHeader->metricHeader->metricHeaderEntries[$i]->name);
            echo "</td>";
        }
        echo "</tr>";
        */
        ...
        for($i = 0; $i < sizeof($data->data->rows);$i++)    {
            echo "<script>";
            echo "pd = {
                Date:'"  . $data->data->rows[$i]->dimensions[0] . "',
                Year:'"  . $data->data->rows[$i]->dimensions[1] . "',
                Month:'" . $data->data->rows[$i]->dimensions[2] . "',
                Day:'"    . $data->data->rows[$i]->dimensions[3] . "',
                Hour:'"  . $data->data->rows[$i]->dimensions[4] . "',
                Minute:'" . $data->data->rows[$i]->dimensions[5] . "',
                PageViews:'" . $data->data->rows[$i]->metrics[0]->values[0] . "',
                Sessions:'"  . $data->data->rows[$i]->metrics[0]->values[1] . "'
            };";
            echo "propertyData.push(pd);";
            echo "</script>";
        }
...
?>
  ...
  <center>© <?php echo date("Y"); ?> Broadway Media</center>
